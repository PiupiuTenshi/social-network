# PH04-FE-CHAT-02-P1-01 — Triển khai CHAT-02 P1: Hội thoại

## Mục tiêu và phạm vi

- Phase: PH04 | Nhóm: FE | Ưu tiên: P1 | Task cha: PH04-FE-CHAT-02-P1.
- Mục tiêu duy nhất: Triển khai CHAT-02 P1: Hội thoại.
- Miền: cross-cutting | Chức năng: MED-06, CHT-09.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH04-FE-CHAT-02-P1-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /tin-nhan/:id. Vai trò: Thành viên hội thoại. Chỉ bật MED-06, CHT-09 tại P1. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH04-FE-CHAT-02-P1-01
...
- **AC01**: Màn hình CHAT-02 tại /tin-nhan/:id thực hiện đúng quyền Thành viên hội thoại và capability MED-06, CHT-09.
...
Ghi `TASK_ID=PH04-FE-CHAT-02-P1-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
