# PH04-FE-COMM-05-P1-01 — Triển khai COMM-05 P1: Quản lý kênh

## Mục tiêu và phạm vi

- Phase: PH04 | Nhóm: FE | Ưu tiên: P1 | Task cha: PH04-FE-COMM-05-P1.
- Mục tiêu duy nhất: Triển khai COMM-05 P1: Quản lý kênh.
- Miền: cross-cutting | Chức năng: COM-04.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH04-FE-COMM-05-P1-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /cong-dong/:id/kenh. Vai trò: Điều hành viên. Chỉ bật COM-04 tại P1. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH04-FE-COMM-05-P1-01
...
1. Mục tiêu screen: Tạo, sắp xếp và cấu hình kênh văn bản hoặc thoại theo quyền.
...
- **AC01**: Màn hình COMM-05 tại /cong-dong/:id/kenh thực hiện đúng quyền Điều hành viên và capability COM-04.
- **AC02**: Trạng thái riêng được kiểm chứng: - Có kênh; - Rỗng; - Projection trò chuyện đang đồng bộ; - Không đủ quyền; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH04-FE-COMM-05-P1-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
