# PH03-FE-FEED-03-P0-01 — Triển khai FEED-03 P0: Chi tiết bài viết

## Mục tiêu và phạm vi

- Phase: PH03 | Nhóm: FE | Ưu tiên: P0 | Task cha: PH03-FE-FEED-03-P0.
- Mục tiêu duy nhất: Triển khai FEED-03 P0: Chi tiết bài viết.
- Miền: cross-cutting | Chức năng: SOC-06, SOC-07, SOC-08, SOC-04, SOC-05.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH03-FE-FEED-03-P0-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /bai-viet/:id. Vai trò: Người xem, Người dùng. Chỉ bật SOC-06, SOC-07, SOC-08, SOC-04, SOC-05 tại P0. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH03-FE-FEED-03-P0-01
...
1. Mục tiêu screen: Đọc bài viết, xem chuỗi bình luận, trả lời, tương tác, chia sẻ và báo cáo.
...
- **AC01**: Màn hình FEED-03 tại /bai-viet/:id thực hiện đúng quyền Người xem, Người dùng và capability SOC-06, SOC-07, SOC-08, SOC-04, SOC-05.
- **AC02**: Trạng thái riêng được kiểm chứng: - Đang tải; - Có nội dung; - Bài viết riêng tư; - Đã xóa; - Bị chặn; - Lỗi bình luận; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH03-FE-FEED-03-P0-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
