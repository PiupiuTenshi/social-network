# PH03-BE-CHT-05-02 — Nghiệm thu CHT-05 và bàn giao

## Mục tiêu và phạm vi

- Phase: PH03 | Nhóm: BE | Ưu tiên: P0 | Task cha: PH03-BE-CHT-05.
- Mục tiêu duy nhất: Nghiệm thu CHT-05 và bàn giao.
- Miền: chat | Chức năng: CHT-05.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH03-BE-CHT-05-02`; chưa được tạo chỉ vì có trong prompt.
...
```powershell
python -X utf8 scripts/task_gate.py check PH03-BE-CHT-05-02
...
1. Rà soát CHT-05 với dữ liệu/HTTP/sự kiện thật; mở rộng từ happy path sang các ca Drop khi offline; auto-expire.
2. Chạy unit/integration/contract/architecture phù hợp, format/analyzer/build; đồng bộ tài liệu và handoff.

## Tiêu chí chấp nhận

- **AC01**: Tất cả tiêu chí CHT-05 có report: Drop khi offline; auto-expire; không test bỏ qua hoặc lỗi Critical/High.
...
Ghi `TASK_ID=PH03-BE-CHT-05-02`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
