# PH04-FE-COMM-04-P1-01 — Triển khai COMM-04 P1: Vai trò và quyền

## Mục tiêu và phạm vi

- Phase: PH04 | Nhóm: FE | Ưu tiên: P1 | Task cha: PH04-FE-COMM-04-P1.
- Mục tiêu duy nhất: Triển khai COMM-04 P1: Vai trò và quyền.
- Miền: cross-cutting | Chức năng: COM-03.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH04-FE-COMM-04-P1-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /cong-dong/:id/vai-tro. Vai trò: Chủ sở hữu, Điều hành viên. Chỉ bật COM-03 tại P1. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH04-FE-COMM-04-P1-01
...
1. Mục tiêu screen: Tạo vai trò, sắp xếp độ ưu tiên, cấp quyền và gán thành viên mà không cho phép leo quyền.
...
- **AC01**: Màn hình COMM-04 tại /cong-dong/:id/vai-tro thực hiện đúng quyền Chủ sở hữu, Điều hành viên và capability COM-03.
- **AC02**: Trạng thái riêng được kiểm chứng: - Danh sách vai trò; - Đang chỉnh sửa; - Cố leo quyền bị chặn; - Xung đột phiên bản; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH04-FE-COMM-04-P1-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
