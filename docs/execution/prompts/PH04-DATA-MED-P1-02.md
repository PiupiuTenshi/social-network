...
```powershell
python -X utf8 scripts/task_gate.py check PH04-DATA-MED-P1-02
...
Ghi `TASK_ID=PH04-DATA-MED-P1-02`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
