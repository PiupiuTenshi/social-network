...
```powershell
python -X utf8 scripts/task_gate.py check PH06-DATA-AI-P2-03
...
- **AC01**: Test chứng minh bất biến của ai_embedding/chunk/job/transcript/interest vector; model version, ACL, pgvector, checkpoint/rebuild; không có truy vấn chéo DB.
...
Ghi `TASK_ID=PH06-DATA-AI-P2-03`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
