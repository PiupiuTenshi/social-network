# PH03-FE-FEED-01-P0-01 — Triển khai FEED-01 P0: Bảng tin

## Mục tiêu và phạm vi

- Phase: PH03 | Nhóm: FE | Ưu tiên: P0 | Task cha: PH03-FE-FEED-01-P0.
- Mục tiêu duy nhất: Triển khai FEED-01 P0: Bảng tin.
- Miền: cross-cutting | Chức năng: FED-02, SOC-03, SOC-08, CHT-08.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH03-FE-FEED-01-P0-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /bang-tin. Vai trò: Người dùng. Chỉ bật FED-02, SOC-03, SOC-08, CHT-08 tại P0. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH03-FE-FEED-01-P0-01
...
1. Mục tiêu screen: Hiển thị bảng tin theo con trỏ, hỗ trợ tạo bài viết nhanh, tương tác và điều hướng đến chi tiết.
...
- **AC01**: Màn hình FEED-01 tại /bang-tin thực hiện đúng quyền Người dùng và capability FED-02, SOC-03, SOC-08, CHT-08.
- **AC02**: Trạng thái riêng được kiểm chứng: - Đang tải khung; - Có dữ liệu; - Hết dữ liệu; - Cache miss; - Ngoại tuyến; - Bài viết bị ẩn theo quyền; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH03-FE-FEED-01-P0-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
