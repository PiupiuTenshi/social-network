# PH04-DATA-SOC-P1-03 — Kiểm chứng dữ liệu SOC P1

## Mục tiêu và phạm vi

- Phase: PH04 | Nhóm: DATA | Ưu tiên: P1 | Task cha: PH04-DATA-SOC-P1.
- Mục tiêu duy nhất: Kiểm chứng dữ liệu SOC P1.
...
- Nhánh đề xuất: `feat/PH04-DATA-SOC-P1-03`; chưa được tạo chỉ vì có trong prompt.
- post_share và video processing/publication; không gộp nhầm visibility/privacy

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH04-DATA-SOC-P1-03
...
- **AC01**: Test chứng minh bất biến của post_share và video processing/publication; không gộp nhầm visibility/privacy; không có truy vấn chéo DB.
...
Ghi `TASK_ID=PH04-DATA-SOC-P1-03`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
