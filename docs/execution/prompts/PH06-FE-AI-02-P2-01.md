# PH06-FE-AI-02-P2-01 — Triển khai AI-02 P2: Tóm tắt hội thoại hoặc kênh

## Mục tiêu và phạm vi

- Phase: PH06 | Nhóm: FE | Ưu tiên: P2 | Task cha: PH06-FE-AI-02-P2.
- Mục tiêu duy nhất: Triển khai AI-02 P2: Tóm tắt hội thoại hoặc kênh.
- Miền: cross-cutting | Chức năng: AI-04.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH06-FE-AI-02-P2-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /tro-ly/tom-tat. Vai trò: Thành viên có quyền. Chỉ bật AI-04 tại P2. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH06-FE-AI-02-P2-01
...
1. Mục tiêu screen: Chọn phạm vi nội dung đã được Trò chuyện cấp quyền và tạo bản tóm tắt có giới hạn.
...
- **AC01**: Màn hình AI-02 tại /tro-ly/tom-tat thực hiện đúng quyền Thành viên có quyền và capability AI-04.
- **AC02**: Trạng thái riêng được kiểm chứng: - Chưa chọn phạm vi; - Đang xử lý; - Hoàn tất; - Nội dung quá lớn; - Mất quyền; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH06-FE-AI-02-P2-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
