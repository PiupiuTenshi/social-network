...
```powershell
python -X utf8 scripts/task_gate.py check PH04-DATA-MED-P1-03
...
- **AC01**: Test chứng minh bất biến của UploadSession/MediaAsset, object metadata; state, expiry, reference/retention_hold và cleanup; không có truy vấn chéo DB.
...
Ghi `TASK_ID=PH04-DATA-MED-P1-03`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
