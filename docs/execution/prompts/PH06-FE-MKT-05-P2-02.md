# PH06-FE-MKT-05-P2-02 — QA MKT-05 P2 trên Desktop/Mobile

## Mục tiêu và phạm vi

- Phase: PH06 | Nhóm: FE | Ưu tiên: P2 | Task cha: PH06-FE-MKT-05-P2.
- Mục tiêu duy nhất: QA MKT-05 P2 trên Desktop/Mobile.
- Miền: cross-cutting | Chức năng: MKT-05.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH06-FE-MKT-05-P2-02`; chưa được tạo chỉ vì có trong prompt.
...
```powershell
python -X utf8 scripts/task_gate.py check PH06-FE-MKT-05-P2-02
...
- **AC01**: MKT-05 P2 có mapping design → code/test, ảnh Desktop/Mobile và sai khác có lý do.
...
Ghi `TASK_ID=PH06-FE-MKT-05-P2-02`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
