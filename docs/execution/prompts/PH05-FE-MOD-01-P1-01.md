# PH05-FE-MOD-01-P1-01 — Triển khai MOD-01 P1: Báo cáo nội dung

## Mục tiêu và phạm vi

- Phase: PH05 | Nhóm: FE | Ưu tiên: P1 | Task cha: PH05-FE-MOD-01-P1.
- Mục tiêu duy nhất: Triển khai MOD-01 P1: Báo cáo nội dung.
- Miền: cross-cutting | Chức năng: MOD-01.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH05-FE-MOD-01-P1-01`; chưa được tạo chỉ vì có trong prompt.
- Route: hộp thoại. Vai trò: Người dùng. Chỉ bật MOD-01 tại P1. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH05-FE-MOD-01-P1-01
...
1. Mục tiêu screen: Thu thập lý do, mô tả tối thiểu và bằng chứng cần thiết mà không làm lộ dữ liệu điều hành.
...
- **AC01**: Màn hình MOD-01 tại hộp thoại thực hiện đúng quyền Người dùng và capability MOD-01.
- **AC02**: Trạng thái riêng được kiểm chứng: - Chọn lý do; - Nhập mô tả; - Gửi thành công; - Báo cáo trùng; - Giới hạn tần suất; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH05-FE-MOD-01-P1-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
