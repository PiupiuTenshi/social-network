...
1. Rà soát SOC-05 với dữ liệu/HTTP/sự kiện thật; mở rộng từ happy path sang các ca Xóa lặp; projection được dọn.
2. Chạy unit/integration/contract/architecture phù hợp, format/analyzer/build; đồng bộ tài liệu và handoff.

## Tiêu chí chấp nhận

- **AC01**: Tất cả tiêu chí SOC-05 có report: Xóa lặp; projection được dọn; không test bỏ qua hoặc lỗi Critical/High.
...
Ghi `TASK_ID=PH03-BE-SOC-05-02`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
