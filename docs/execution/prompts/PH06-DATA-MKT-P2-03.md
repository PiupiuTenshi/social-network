# PH06-DATA-MKT-P2-03 — Kiểm chứng dữ liệu MKT P2

## Mục tiêu và phạm vi

- Phase: PH06 | Nhóm: DATA | Ưu tiên: P2 | Task cha: PH06-DATA-MKT-P2.
- Mục tiêu duy nhất: Kiểm chứng dữ liệu MKT P2.
...
- Nhánh đề xuất: `feat/PH06-DATA-MKT-P2-03`; chưa được tạo chỉ vì có trong prompt.
...
```powershell
python -X utf8 scripts/task_gate.py check PH06-DATA-MKT-P2-03
...
- **AC01**: Test chứng minh bất biến của listing/media_ref/inventory/order/item/payment/history; số tiền snapshot, reserved constraint, idempotency; không có truy vấn chéo DB.
...
Ghi `TASK_ID=PH06-DATA-MKT-P2-03`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
