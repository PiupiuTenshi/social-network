# PH05-FE-MOD-02-P1-01 — Triển khai MOD-02 P1: Hàng đợi điều hành

## Mục tiêu và phạm vi

- Phase: PH05 | Nhóm: FE | Ưu tiên: P1 | Task cha: PH05-FE-MOD-02-P1.
- Mục tiêu duy nhất: Triển khai MOD-02 P1: Hàng đợi điều hành.
- Miền: cross-cutting | Chức năng: MOD-02.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH05-FE-MOD-02-P1-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /dieu-hanh/bao-cao. Vai trò: Điều hành viên, Quản trị viên. Chỉ bật MOD-02 tại P1. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH05-FE-MOD-02-P1-01
...
1. Mục tiêu screen: Duyệt báo cáo theo ưu tiên, trạng thái, loại nội dung và người được phân công.
...
- **AC01**: Màn hình MOD-02 tại /dieu-hanh/bao-cao thực hiện đúng quyền Điều hành viên, Quản trị viên và capability MOD-02.
- **AC02**: Trạng thái riêng được kiểm chứng: - Có dữ liệu; - Rỗng; - Đang lọc; - Không đủ quyền; - Dữ liệu nhạy cảm đã che; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH05-FE-MOD-02-P1-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
