# PH02-FE-AUTH-02-P0-01 — Triển khai AUTH-02 P0: Đăng nhập

## Mục tiêu và phạm vi

- Phase: PH02 | Nhóm: FE | Ưu tiên: P0 | Task cha: PH02-FE-AUTH-02-P0.
- Mục tiêu duy nhất: Triển khai AUTH-02 P0: Đăng nhập.
- Miền: cross-cutting | Chức năng: ACC-02, ACC-03.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH02-FE-AUTH-02-P0-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /dang-nhap. Vai trò: Khách. Chỉ bật ACC-02, ACC-03 tại P0. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH02-FE-AUTH-02-P0-01
...
- **AC01**: Màn hình AUTH-02 tại /dang-nhap thực hiện đúng quyền Khách và capability ACC-02, ACC-03.
...
Ghi `TASK_ID=PH02-FE-AUTH-02-P0-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
