# PH05-FE-MOD-03-P1-01 — Triển khai MOD-03 P1: Chi tiết điều hành

## Mục tiêu và phạm vi

- Phase: PH05 | Nhóm: FE | Ưu tiên: P1 | Task cha: PH05-FE-MOD-03-P1.
- Mục tiêu duy nhất: Triển khai MOD-03 P1: Chi tiết điều hành.
- Miền: cross-cutting | Chức năng: MOD-03, MOD-04.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH05-FE-MOD-03-P1-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /dieu-hanh/bao-cao/:id. Vai trò: Điều hành viên, Quản trị viên. Chỉ bật MOD-03, MOD-04 tại P1. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH05-FE-MOD-03-P1-01
...
1. Mục tiêu screen: Xem bằng chứng được phép, ghi lý do, yêu cầu hành động và đóng hồ sơ với nhật ký bất biến.
...
- **AC01**: Màn hình MOD-03 tại /dieu-hanh/bao-cao/:id thực hiện đúng quyền Điều hành viên, Quản trị viên và capability MOD-03, MOD-04.
- **AC02**: Trạng thái riêng được kiểm chứng: - Pending; - InReview; - ActionPending; - Actioned; - Rejected; - Closed; - Xung đột phiên bản; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH05-FE-MOD-03-P1-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
