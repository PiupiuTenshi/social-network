# PH04-BE-SOC-09-02 — Nghiệm thu SOC-09 và bàn giao

## Mục tiêu và phạm vi

- Phase: PH04 | Nhóm: BE | Ưu tiên: P1 | Task cha: PH04-BE-SOC-09.
- Mục tiêu duy nhất: Nghiệm thu SOC-09 và bàn giao.
- Miền: social | Chức năng: SOC-09.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH04-BE-SOC-09-02`; chưa được tạo chỉ vì có trong prompt.
...
```powershell
python -X utf8 scripts/task_gate.py check PH04-BE-SOC-09-02
...
1. Rà soát SOC-09 với dữ liệu/HTTP/sự kiện thật; mở rộng từ happy path sang các ca Ready/Failed; không vào bảng tin sớm.
2. Chạy unit/integration/contract/architecture phù hợp, format/analyzer/build; đồng bộ tài liệu và handoff.

## Tiêu chí chấp nhận

- **AC01**: Tất cả tiêu chí SOC-09 có report: Ready/Failed; không vào bảng tin sớm; không test bỏ qua hoặc lỗi Critical/High.
...
Ghi `TASK_ID=PH04-BE-SOC-09-02`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
