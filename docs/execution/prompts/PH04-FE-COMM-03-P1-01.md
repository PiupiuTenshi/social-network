# PH04-FE-COMM-03-P1-01 — Triển khai COMM-03 P1: Mời và tham gia cộng đồng

## Mục tiêu và phạm vi

- Phase: PH04 | Nhóm: FE | Ưu tiên: P1 | Task cha: PH04-FE-COMM-03-P1.
- Mục tiêu duy nhất: Triển khai COMM-03 P1: Mời và tham gia cộng đồng.
- Miền: cross-cutting | Chức năng: COM-02.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH04-FE-COMM-03-P1-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /loi-moi/:code. Vai trò: Người dùng. Chỉ bật COM-02 tại P1. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH04-FE-COMM-03-P1-01
...
1. Mục tiêu screen: Xác nhận thông tin lời mời, hạn dùng và quyền trước khi tham gia.
...
- **AC01**: Màn hình COMM-03 tại /loi-moi/:code thực hiện đúng quyền Người dùng và capability COM-02.
- **AC02**: Trạng thái riêng được kiểm chứng: - Hợp lệ; - Hết hạn; - Hết lượt; - Đã là thành viên; - Bị cấm; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH04-FE-COMM-03-P1-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
