# PH03-BE-SOC-06-02 — Nghiệm thu SOC-06 và bàn giao

## Mục tiêu và phạm vi

- Phase: PH03 | Nhóm: BE | Ưu tiên: P0 | Task cha: PH03-BE-SOC-06.
- Mục tiêu duy nhất: Nghiệm thu SOC-06 và bàn giao.
- Miền: social | Chức năng: SOC-06.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH03-BE-SOC-06-02`; chưa được tạo chỉ vì có trong prompt.
...
```powershell
python -X utf8 scripts/task_gate.py check PH03-BE-SOC-06-02
...
1. Rà soát SOC-06 với dữ liệu/HTTP/sự kiện thật; mở rộng từ happy path sang các ca Ẩn nội dung; cursor không trùng/bỏ.
2. Chạy unit/integration/contract/architecture phù hợp, format/analyzer/build; đồng bộ tài liệu và handoff.

## Tiêu chí chấp nhận

- **AC01**: Tất cả tiêu chí SOC-06 có report: Ẩn nội dung; cursor không trùng/bỏ; không test bỏ qua hoặc lỗi Critical/High.
...
Ghi `TASK_ID=PH03-BE-SOC-06-02`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
