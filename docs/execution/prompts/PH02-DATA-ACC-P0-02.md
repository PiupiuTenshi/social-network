# PH02-DATA-ACC-P0-02 — Migration và fixture ACC P0

## Mục tiêu và phạm vi

- Phase: PH02 | Nhóm: DATA | Ưu tiên: P0 | Task cha: PH02-DATA-ACC-P0.
- Mục tiêu duy nhất: Migration và fixture ACC P0.
...
- Nhánh đề xuất: `feat/PH02-DATA-ACC-P0-02`; chưa được tạo chỉ vì có trong prompt.
...
```powershell
python -X utf8 scripts/task_gate.py check PH02-DATA-ACC-P0-02
...
Ghi `TASK_ID=PH02-DATA-ACC-P0-02`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
