# PH04-FE-RTC-02-P1-01 — Triển khai RTC-02 P1: Phòng thoại và video

## Mục tiêu và phạm vi

- Phase: PH04 | Nhóm: FE | Ưu tiên: P1 | Task cha: PH04-FE-RTC-02-P1.
- Mục tiêu duy nhất: Triển khai RTC-02 P1: Phòng thoại và video.
- Miền: cross-cutting | Chức năng: RTC-01, RTC-02.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH04-FE-RTC-02-P1-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /cong-dong/:id/phong/:roomId. Vai trò: Thành viên. Chỉ bật RTC-01, RTC-02 tại P1. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH04-FE-RTC-02-P1-01
...
1. Mục tiêu screen: Hiển thị người tham gia, điều khiển micro/camera, chất lượng kết nối và quyền phát biểu.
...
- **AC01**: Màn hình RTC-02 tại /cong-dong/:id/phong/:roomId thực hiện đúng quyền Thành viên và capability RTC-01, RTC-02.
- **AC02**: Trạng thái riêng được kiểm chứng: - Đang kết nối; - Đã kết nối; - Đang dùng TURN; - Mất quyền phát biểu; - LiveKit lỗi; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH04-FE-RTC-02-P1-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
