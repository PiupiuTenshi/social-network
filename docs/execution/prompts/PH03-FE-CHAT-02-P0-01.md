# PH03-FE-CHAT-02-P0-01 — Triển khai CHAT-02 P0: Hội thoại

## Mục tiêu và phạm vi

- Phase: PH03 | Nhóm: FE | Ưu tiên: P0 | Task cha: PH03-FE-CHAT-02-P0.
- Mục tiêu duy nhất: Triển khai CHAT-02 P0: Hội thoại.
- Miền: cross-cutting | Chức năng: CHT-02, CHT-03, CHT-04, CHT-05, CHT-06, CHT-07.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH03-FE-CHAT-02-P0-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /tin-nhan/:id. Vai trò: Thành viên hội thoại. Chỉ bật CHT-02, CHT-03, CHT-04, CHT-05, CHT-06, CHT-07 tại P0. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH03-FE-CHAT-02-P0-01
...
1. Mục tiêu screen: Gửi và nhận tin nhắn an toàn, hỗ trợ trạng thái đang nhập, hiện diện, đã đọc và gửi lại khi mất mạng.
...
- **AC01**: Màn hình CHAT-02 tại /tin-nhan/:id thực hiện đúng quyền Thành viên hội thoại và capability CHT-02, CHT-03, CHT-04, CHT-05, CHT-06, CHT-07.
- **AC02**: Trạng thái riêng được kiểm chứng: - Đang kết nối; - Đã kết nối; - Tin đang gửi; - Gửi thất bại; - Đã đọc; - Đang nhập; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH03-FE-CHAT-02-P0-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
