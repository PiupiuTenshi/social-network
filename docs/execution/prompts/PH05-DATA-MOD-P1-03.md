# PH05-DATA-MOD-P1-03 — Kiểm chứng dữ liệu MOD P1

## Mục tiêu và phạm vi

- Phase: PH05 | Nhóm: DATA | Ưu tiên: P1 | Task cha: PH05-DATA-MOD-P1.
- Mục tiêu duy nhất: Kiểm chứng dữ liệu MOD P1.
...
- Nhánh đề xuất: `feat/PH05-DATA-MOD-P1-03`; chưa được tạo chỉ vì có trong prompt.
- content_report/moderation_evidence/moderation_action; audit append-only và state machine

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH05-DATA-MOD-P1-03
...
- **AC01**: Test chứng minh bất biến của content_report/moderation_evidence/moderation_action; audit append-only và state machine; không có truy vấn chéo DB.
...
Ghi `TASK_ID=PH05-DATA-MOD-P1-03`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
