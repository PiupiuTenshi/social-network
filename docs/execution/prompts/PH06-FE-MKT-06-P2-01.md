# PH06-FE-MKT-06-P2-01 — Triển khai MKT-06 P2: Đơn hàng

## Mục tiêu và phạm vi

- Phase: PH06 | Nhóm: FE | Ưu tiên: P2 | Task cha: PH06-FE-MKT-06-P2.
- Mục tiêu duy nhất: Triển khai MKT-06 P2: Đơn hàng.
- Miền: cross-cutting | Chức năng: MKT-06, MKT-04, MKT-05.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH06-FE-MKT-06-P2-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /cho/don-hang. Vai trò: Người mua, Người bán. Chỉ bật MKT-06, MKT-04, MKT-05 tại P2. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH06-FE-MKT-06-P2-01
...
1. Mục tiêu screen: Theo dõi danh sách và chi tiết trạng thái đơn hàng theo máy trạng thái được phép.
...
- **AC01**: Màn hình MKT-06 tại /cho/don-hang thực hiện đúng quyền Người mua, Người bán và capability MKT-06, MKT-04, MKT-05.
- **AC02**: Trạng thái riêng được kiểm chứng: - Rỗng; - Đang chờ thanh toán; - Đã thanh toán; - Đang xử lý; - Hoàn tất; - Đã hủy; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH06-FE-MKT-06-P2-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
