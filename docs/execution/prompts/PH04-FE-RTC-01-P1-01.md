# PH04-FE-RTC-01-P1-01 — Triển khai RTC-01 P1: Lời mời cuộc gọi

## Mục tiêu và phạm vi

- Phase: PH04 | Nhóm: FE | Ưu tiên: P1 | Task cha: PH04-FE-RTC-01-P1.
- Mục tiêu duy nhất: Triển khai RTC-01 P1: Lời mời cuộc gọi.
- Miền: cross-cutting | Chức năng: CHT-09, RTC-01.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH04-FE-RTC-01-P1-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /cuoc-goi/:id. Vai trò: Người dùng, Thành viên. Chỉ bật CHT-09, RTC-01 tại P1. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH04-FE-RTC-01-P1-01
...
1. Mục tiêu screen: Hiển thị lời mời thoại/video với thời gian chờ, kiểm tra quyền và điều hướng đến LiveKit.
...
- **AC01**: Màn hình RTC-01 tại /cuoc-goi/:id thực hiện đúng quyền Người dùng, Thành viên và capability CHT-09, RTC-01.
- **AC02**: Trạng thái riêng được kiểm chứng: - Đang đổ chuông; - Hết thời gian; - Đã từ chối; - Không có quyền; - LiveKit tạm thời không khả dụng; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH04-FE-RTC-01-P1-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
