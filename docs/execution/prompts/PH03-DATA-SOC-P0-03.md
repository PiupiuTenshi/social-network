# PH03-DATA-SOC-P0-03 — Kiểm chứng dữ liệu SOC P0

## Mục tiêu và phạm vi

- Phase: PH03 | Nhóm: DATA | Ưu tiên: P0 | Task cha: PH03-DATA-SOC-P0.
- Mục tiêu duy nhất: Kiểm chứng dữ liệu SOC P0.
...
- Nhánh đề xuất: `feat/PH03-DATA-SOC-P0-03`; chưa được tạo chỉ vì có trong prompt.
...
```powershell
python -X utf8 scripts/task_gate.py check PH03-DATA-SOC-P0-03
...
- **AC01**: Test chứng minh bất biến của follow, block, post, post_media_ref, comment, reaction; unique/check, visibility/version và cursor; không có truy vấn chéo DB.
...
Ghi `TASK_ID=PH03-DATA-SOC-P0-03`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
