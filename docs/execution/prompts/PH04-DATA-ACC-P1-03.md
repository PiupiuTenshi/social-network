# PH04-DATA-ACC-P1-03 — Kiểm chứng dữ liệu ACC P1

## Mục tiêu và phạm vi

- Phase: PH04 | Nhóm: DATA | Ưu tiên: P1 | Task cha: PH04-DATA-ACC-P1.
- Mục tiêu duy nhất: Kiểm chứng dữ liệu ACC P1.
...
- Nhánh đề xuất: `feat/PH04-DATA-ACC-P1-03`; chưa được tạo chỉ vì có trong prompt.
...
```powershell
python -X utf8 scripts/task_gate.py check PH04-DATA-ACC-P1-03
...
- **AC01**: Test chứng minh bất biến của password_reset_token, account_oauth, avatar refs; OTP hash/attempt/TTL và unique provider identity; không có truy vấn chéo DB.
...
Ghi `TASK_ID=PH04-DATA-ACC-P1-03`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
