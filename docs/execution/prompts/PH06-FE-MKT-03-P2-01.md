# PH06-FE-MKT-03-P2-01 — Triển khai MKT-03 P2: Tạo hoặc sửa tin đăng

## Mục tiêu và phạm vi

- Phase: PH06 | Nhóm: FE | Ưu tiên: P2 | Task cha: PH06-FE-MKT-03-P2.
- Mục tiêu duy nhất: Triển khai MKT-03 P2: Tạo hoặc sửa tin đăng.
- Miền: cross-cutting | Chức năng: MKT-01, MKT-03, MKT-07.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH06-FE-MKT-03-P2-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /cho/tin/moi. Vai trò: Người bán. Chỉ bật MKT-01, MKT-03, MKT-07 tại P2. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH06-FE-MKT-03-P2-01
...
1. Mục tiêu screen: Soạn tin, gắn phương tiện Ready, đặt giá/tồn kho và lưu bằng If-Match khi chỉnh sửa.
...
- **AC01**: Màn hình MKT-03 tại /cho/tin/moi thực hiện đúng quyền Người bán và capability MKT-01, MKT-03, MKT-07.
- **AC02**: Trạng thái riêng được kiểm chứng: - Rỗng; - Dữ liệu sai; - Phương tiện chưa sẵn sàng; - Xung đột phiên bản; - Đã đăng; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH06-FE-MKT-03-P2-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
