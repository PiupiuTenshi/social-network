# PH06-BE-MKT-04-02 — Nghiệm thu MKT-04 và bàn giao

## Mục tiêu và phạm vi

- Phase: PH06 | Nhóm: BE | Ưu tiên: P2 | Task cha: PH06-BE-MKT-04.
- Mục tiêu duy nhất: Nghiệm thu MKT-04 và bàn giao.
- Miền: commerce | Chức năng: MKT-04.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH06-BE-MKT-04-02`; chưa được tạo chỉ vì có trong prompt.
...
```powershell
python -X utf8 scripts/task_gate.py check PH06-BE-MKT-04-02
...
1. Rà soát MKT-04 với dữ liệu/HTTP/sự kiện thật; mở rộng từ happy path sang các ca Stock fail không ghost order.
2. Chạy unit/integration/contract/architecture phù hợp, format/analyzer/build; đồng bộ tài liệu và handoff.

## Tiêu chí chấp nhận

- **AC01**: Tất cả tiêu chí MKT-04 có report: Stock fail không ghost order; không test bỏ qua hoặc lỗi Critical/High.
...
Ghi `TASK_ID=PH06-BE-MKT-04-02`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
