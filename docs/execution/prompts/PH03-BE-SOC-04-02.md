...
1. Rà soát SOC-04 với dữ liệu/HTTP/sự kiện thật; mở rộng từ happy path sang các ca Stale trả 412; không phải owner.
2. Chạy unit/integration/contract/architecture phù hợp, format/analyzer/build; đồng bộ tài liệu và handoff.

## Tiêu chí chấp nhận

- **AC01**: Tất cả tiêu chí SOC-04 có report: Stale trả 412; không phải owner; không test bỏ qua hoặc lỗi Critical/High.
...
Ghi `TASK_ID=PH03-BE-SOC-04-02`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
