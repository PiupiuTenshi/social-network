# PH04-FE-COMM-05-P1-02 — QA COMM-05 P1 trên Desktop/Mobile

## Mục tiêu và phạm vi

- Phase: PH04 | Nhóm: FE | Ưu tiên: P1 | Task cha: PH04-FE-COMM-05-P1.
- Mục tiêu duy nhất: QA COMM-05 P1 trên Desktop/Mobile.
- Miền: cross-cutting | Chức năng: COM-04.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH04-FE-COMM-05-P1-02`; chưa được tạo chỉ vì có trong prompt.
...
```powershell
python -X utf8 scripts/task_gate.py check PH04-FE-COMM-05-P1-02
...
- **AC01**: COMM-05 P1 có mapping design → code/test, ảnh Desktop/Mobile và sai khác có lý do.
...
Ghi `TASK_ID=PH04-FE-COMM-05-P1-02`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
