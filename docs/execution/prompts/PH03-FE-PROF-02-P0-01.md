# PH03-FE-PROF-02-P0-01 — Triển khai PROF-02 P0: Hồ sơ người dùng

## Mục tiêu và phạm vi

- Phase: PH03 | Nhóm: FE | Ưu tiên: P0 | Task cha: PH03-FE-PROF-02-P0.
- Mục tiêu duy nhất: Triển khai PROF-02 P0: Hồ sơ người dùng.
- Miền: cross-cutting | Chức năng: ACC-05, SOC-01, SOC-02, SOC-06, CHT-01.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH03-FE-PROF-02-P0-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /nguoi-dung/:id. Vai trò: Người xem. Chỉ bật ACC-05, SOC-01, SOC-02, SOC-06, CHT-01 tại P0. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH03-FE-PROF-02-P0-01
...
1. Mục tiêu screen: Xem hồ sơ theo quyền riêng tư, theo dõi hoặc chặn và duyệt bài viết hiển thị được.
...
- **AC01**: Màn hình PROF-02 tại /nguoi-dung/:id thực hiện đúng quyền Người xem và capability ACC-05, SOC-01, SOC-02, SOC-06, CHT-01.
- **AC02**: Trạng thái riêng được kiểm chứng: - Công khai; - Chỉ người theo dõi; - Đã theo dõi; - Đã chặn; - Hồ sơ không tồn tại; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH03-FE-PROF-02-P0-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
