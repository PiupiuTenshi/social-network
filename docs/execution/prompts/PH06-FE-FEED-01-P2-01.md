# PH06-FE-FEED-01-P2-01 — Triển khai FEED-01 P2: Bảng tin

## Mục tiêu và phạm vi

- Phase: PH06 | Nhóm: FE | Ưu tiên: P2 | Task cha: PH06-FE-FEED-01-P2.
- Mục tiêu duy nhất: Triển khai FEED-01 P2: Bảng tin.
- Miền: cross-cutting | Chức năng: FED-04.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH06-FE-FEED-01-P2-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /bang-tin. Vai trò: Người dùng. Chỉ bật FED-04 tại P2. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH06-FE-FEED-01-P2-01
...
- **AC01**: Màn hình FEED-01 tại /bang-tin thực hiện đúng quyền Người dùng và capability FED-04.
...
Ghi `TASK_ID=PH06-FE-FEED-01-P2-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
