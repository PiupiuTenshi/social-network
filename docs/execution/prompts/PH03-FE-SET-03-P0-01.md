# PH03-FE-SET-03-P0-01 — Triển khai SET-03 P0: Tài khoản đã chặn

## Mục tiêu và phạm vi

- Phase: PH03 | Nhóm: FE | Ưu tiên: P0 | Task cha: PH03-FE-SET-03-P0.
- Mục tiêu duy nhất: Triển khai SET-03 P0: Tài khoản đã chặn.
- Miền: cross-cutting | Chức năng: SOC-02.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH03-FE-SET-03-P0-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /thiet-lap/da-chan. Vai trò: Người dùng. Chỉ bật SOC-02 tại P0. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH03-FE-SET-03-P0-01
...
1. Mục tiêu screen: Quản lý danh sách tài khoản đã chặn và bỏ chặn an toàn.
...
- **AC01**: Màn hình SET-03 tại /thiet-lap/da-chan thực hiện đúng quyền Người dùng và capability SOC-02.
- **AC02**: Trạng thái riêng được kiểm chứng: - Có dữ liệu; - Rỗng; - Đang cập nhật; - Thao tác lặp; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH03-FE-SET-03-P0-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
