# PH02-FE-AUTH-02-P0-02 — QA AUTH-02 P0 trên Desktop/Mobile

## Mục tiêu và phạm vi

- Phase: PH02 | Nhóm: FE | Ưu tiên: P0 | Task cha: PH02-FE-AUTH-02-P0.
- Mục tiêu duy nhất: QA AUTH-02 P0 trên Desktop/Mobile.
...
- Nhánh đề xuất: `feat/PH02-FE-AUTH-02-P0-02`; chưa được tạo chỉ vì có trong prompt.
...
```powershell
python -X utf8 scripts/task_gate.py check PH02-FE-AUTH-02-P0-02
...
- **AC01**: AUTH-02 P0 có mapping design → code/test, ảnh Desktop/Mobile và sai khác có lý do.
...
Ghi `TASK_ID=PH02-FE-AUTH-02-P0-02`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
