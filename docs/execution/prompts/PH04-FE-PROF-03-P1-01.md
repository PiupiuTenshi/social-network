# PH04-FE-PROF-03-P1-01 — Triển khai PROF-03 P1: Chỉnh sửa hồ sơ

## Mục tiêu và phạm vi

- Phase: PH04 | Nhóm: FE | Ưu tiên: P1 | Task cha: PH04-FE-PROF-03-P1.
- Mục tiêu duy nhất: Triển khai PROF-03 P1: Chỉnh sửa hồ sơ.
- Miền: cross-cutting | Chức năng: ACC-05, ACC-06, MED-01.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH04-FE-PROF-03-P1-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /toi/chinh-sua. Vai trò: Người dùng. Chỉ bật ACC-05, ACC-06, MED-01 tại P1. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH04-FE-PROF-03-P1-01
...
1. Mục tiêu screen: Cập nhật tên hiển thị, tiểu sử, tên người dùng và avatar đã sẵn sàng.
...
- **AC01**: Màn hình PROF-03 tại /toi/chinh-sua thực hiện đúng quyền Người dùng và capability ACC-05, ACC-06, MED-01.
- **AC02**: Trạng thái riêng được kiểm chứng: - Mặc định; - Tên người dùng đang kiểm tra; - Phương tiện chưa sẵn sàng; - Xung đột phiên bản; - Thành công; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH04-FE-PROF-03-P1-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
