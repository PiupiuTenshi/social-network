# PH06-FE-CHAT-02-P2-01 — Triển khai CHAT-02 P2: Hội thoại

## Mục tiêu và phạm vi

- Phase: PH06 | Nhóm: FE | Ưu tiên: P2 | Task cha: PH06-FE-CHAT-02-P2.
- Mục tiêu duy nhất: Triển khai CHAT-02 P2: Hội thoại.
- Miền: cross-cutting | Chức năng: AI-05.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH06-FE-CHAT-02-P2-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /tin-nhan/:id. Vai trò: Thành viên hội thoại. Chỉ bật AI-05 tại P2. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH06-FE-CHAT-02-P2-01
...
- **AC01**: Màn hình CHAT-02 tại /tin-nhan/:id thực hiện đúng quyền Thành viên hội thoại và capability AI-05.
...
Ghi `TASK_ID=PH06-FE-CHAT-02-P2-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
