# PH00-GOV-AUDIT-01 — Xác nhận nguồn, quy tắc và phạm vi thực tế

## Mục tiêu và phạm vi

- Phase: PH00 | Nhóm: GOV | Ưu tiên: P0 | Task cha: PH00-GOV-AUDIT.
- Mục tiêu duy nhất: Xác nhận nguồn, quy tắc và phạm vi thực tế.
...
- Nhánh đề xuất: `docs/PH00-GOV-AUDIT-01`; chưa được tạo chỉ vì có trong prompt.
...
- Không có tiền nhiệm; vẫn phải chuẩn bị Definition of Ready.
...
1. Đọc DOCUMENT_AUDIT.md và BLOCKERS.md; đối chiếu toàn bộ nguồn v3.0, ADR, UI 1.2 Final.
2. Xác nhận AGENTS.md canonical trên Windows/Linux; ghi quyết định về phiên bản quy tắc và đường vào duy nhất.
3. Ghi kiểm kê 66 chức năng, 47 màn hình; phiên bản SDK, ứng dụng, remote và Git hiện chưa có.

## Tiêu chí chấp nhận

- **AC01**: Có bản kiểm kê nguồn/dấu vân tay và quyết định về đường vào AGENTS không tự tham chiếu.
- **AC02**: Chủ dự án xác nhận P0/P1/P2, phạm vi đóng/tắt gap và cơ chế nghiệm thu; không xem UI approved là API approved.
- **AC03**: Mọi điểm chưa biết có owner và đầu ra cần quyết định; không đánh dấu đã build sản phẩm.
...
Ghi `TASK_ID=PH00-GOV-AUDIT-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
