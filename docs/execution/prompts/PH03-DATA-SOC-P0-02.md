# PH03-DATA-SOC-P0-02 — Migration và fixture SOC P0

## Mục tiêu và phạm vi

- Phase: PH03 | Nhóm: DATA | Ưu tiên: P0 | Task cha: PH03-DATA-SOC-P0.
- Mục tiêu duy nhất: Migration và fixture SOC P0.
...
- Nhánh đề xuất: `feat/PH03-DATA-SOC-P0-02`; chưa được tạo chỉ vì có trong prompt.
...
```powershell
python -X utf8 scripts/task_gate.py check PH03-DATA-SOC-P0-02
...
Ghi `TASK_ID=PH03-DATA-SOC-P0-02`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
