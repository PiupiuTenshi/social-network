# PH06-FE-MKT-05-P2-01 — Triển khai MKT-05 P2: Thanh toán trực tiếp với người bán

## Mục tiêu và phạm vi

- Phase: PH06 | Nhóm: FE | Ưu tiên: P2 | Task cha: PH06-FE-MKT-05-P2.
- Mục tiêu duy nhất: Triển khai MKT-05 P2: Thanh toán trực tiếp với người bán.
- Miền: cross-cutting | Chức năng: MKT-05.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH06-FE-MKT-05-P2-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /cho/don/:id/thanh-toan. Vai trò: Người mua. Chỉ bật MKT-05 tại P2. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH06-FE-MKT-05-P2-01
...
1. Mục tiêu screen: Thực hiện thanh toán giả lập lặp an toàn và hiển thị kết quả mà không gửi trùng.
...
- **AC01**: Màn hình MKT-05 tại /cho/don/:id/thanh-toan thực hiện đúng quyền Người mua và capability MKT-05.
- **AC02**: Trạng thái riêng được kiểm chứng: - Chờ thanh toán; - Đang xử lý; - Thành công; - Thất bại; - Kết quả cũ được trả lại; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH06-FE-MKT-05-P2-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
