# PH04-FE-COMM-02-P1-01 — Triển khai COMM-02 P1: Tổng quan cộng đồng

## Mục tiêu và phạm vi

- Phase: PH04 | Nhóm: FE | Ưu tiên: P1 | Task cha: PH04-FE-COMM-02-P1.
- Mục tiêu duy nhất: Triển khai COMM-02 P1: Tổng quan cộng đồng.
- Miền: cross-cutting | Chức năng: COM-01, COM-02, COM-04.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH04-FE-COMM-02-P1-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /cong-dong/:id. Vai trò: Thành viên, Khách theo chính sách. Chỉ bật COM-01, COM-02, COM-04 tại P1. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH04-FE-COMM-02-P1-01
...
1. Mục tiêu screen: Hiển thị giới thiệu, quy tắc, kênh, thành viên nổi bật và hành động tham gia/rời.
...
- **AC01**: Màn hình COMM-02 tại /cong-dong/:id thực hiện đúng quyền Thành viên, Khách theo chính sách và capability COM-01, COM-02, COM-04.
- **AC02**: Trạng thái riêng được kiểm chứng: - Công khai; - Chưa tham gia; - Đã tham gia; - Bị cấm; - Cộng đồng đã đóng; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH04-FE-COMM-02-P1-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
