...
```powershell
python -X utf8 scripts/task_gate.py check PH03-DATA-CHT-P0-02
...
Ghi `TASK_ID=PH03-DATA-CHT-P0-02`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
