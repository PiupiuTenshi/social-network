# PH04-FE-COMM-07-P1-01 — Triển khai COMM-07 P1: Kênh văn bản

## Mục tiêu và phạm vi

- Phase: PH04 | Nhóm: FE | Ưu tiên: P1 | Task cha: PH04-FE-COMM-07-P1.
- Mục tiêu duy nhất: Triển khai COMM-07 P1: Kênh văn bản.
- Miền: cross-cutting | Chức năng: COM-04, CHT-02, CHT-07.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH04-FE-COMM-07-P1-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /cong-dong/:id/kenh/:channelId. Vai trò: Thành viên. Chỉ bật COM-04, CHT-02, CHT-07 tại P1. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH04-FE-COMM-07-P1-01
...
1. Mục tiêu screen: Trò chuyện theo kênh, xem lịch sử bằng con trỏ và nhận cập nhật thời gian thực.
...
- **AC01**: Màn hình COMM-07 tại /cong-dong/:id/kenh/:channelId thực hiện đúng quyền Thành viên và capability COM-04, CHT-02, CHT-07.
- **AC02**: Trạng thái riêng được kiểm chứng: - Đang kết nối; - Đã kết nối; - Mất kết nối; - Không có quyền; - Kênh đang đồng bộ; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH04-FE-COMM-07-P1-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
