# PH04-FE-RTC-01-P1-02 — QA RTC-01 P1 trên Desktop/Mobile

## Mục tiêu và phạm vi

- Phase: PH04 | Nhóm: FE | Ưu tiên: P1 | Task cha: PH04-FE-RTC-01-P1.
- Mục tiêu duy nhất: QA RTC-01 P1 trên Desktop/Mobile.
...
- Nhánh đề xuất: `feat/PH04-FE-RTC-01-P1-02`; chưa được tạo chỉ vì có trong prompt.
...
```powershell
python -X utf8 scripts/task_gate.py check PH04-FE-RTC-01-P1-02
...
- **AC01**: RTC-01 P1 có mapping design → code/test, ảnh Desktop/Mobile và sai khác có lý do.
...
Ghi `TASK_ID=PH04-FE-RTC-01-P1-02`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
