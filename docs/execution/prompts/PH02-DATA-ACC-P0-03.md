# PH02-DATA-ACC-P0-03 — Kiểm chứng dữ liệu ACC P0

## Mục tiêu và phạm vi

- Phase: PH02 | Nhóm: DATA | Ưu tiên: P0 | Task cha: PH02-DATA-ACC-P0.
- Mục tiêu duy nhất: Kiểm chứng dữ liệu ACC P0.
...
- Nhánh đề xuất: `feat/PH02-DATA-ACC-P0-03`; chưa được tạo chỉ vì có trong prompt.
...
```powershell
python -X utf8 scripts/task_gate.py check PH02-DATA-ACC-P0-03
...
- **AC01**: Test chứng minh bất biến của account, profile, refresh_token, account_setting; token hash/family/version và email/username unique; không có truy vấn chéo DB.
...
Ghi `TASK_ID=PH02-DATA-ACC-P0-03`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
