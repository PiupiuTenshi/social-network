# PH05-DATA-DEL-P1-02 — Migration và fixture DEL P1

## Mục tiêu và phạm vi

- Phase: PH05 | Nhóm: DATA | Ưu tiên: P1 | Task cha: PH05-DATA-DEL-P1.
- Mục tiêu duy nhất: Migration và fixture DEL P1.
...
- Nhánh đề xuất: `feat/PH05-DATA-DEL-P1-02`; chưa được tạo chỉ vì có trong prompt.
...
```powershell
python -X utf8 scripts/task_gate.py check PH05-DATA-DEL-P1-02
...
Ghi `TASK_ID=PH05-DATA-DEL-P1-02`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
