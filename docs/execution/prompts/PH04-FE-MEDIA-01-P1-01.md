# PH04-FE-MEDIA-01-P1-01 — Triển khai MEDIA-01 P1: Tải phương tiện

## Mục tiêu và phạm vi

- Phase: PH04 | Nhóm: FE | Ưu tiên: P1 | Task cha: PH04-FE-MEDIA-01-P1.
- Mục tiêu duy nhất: Triển khai MEDIA-01 P1: Tải phương tiện.
- Miền: cross-cutting | Chức năng: MED-01, MED-02, MED-03, MED-04.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH04-FE-MEDIA-01-P1-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /phuong-tien/tai-len. Vai trò: Người dùng. Chỉ bật MED-01, MED-02, MED-03, MED-04 tại P1. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH04-FE-MEDIA-01-P1-01
...
1. Mục tiêu screen: Tải trực tiếp qua URL ký trước, hiển thị tiến độ và xác minh trước khi tham chiếu.
...
- **AC01**: Màn hình MEDIA-01 tại /phuong-tien/tai-len thực hiện đúng quyền Người dùng và capability MED-01, MED-02, MED-03, MED-04.
- **AC02**: Trạng thái riêng được kiểm chứng: - Chờ chọn; - Đang tải; - Đang xác minh; - Đang xử lý; - Sẵn sàng; - Thất bại; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH04-FE-MEDIA-01-P1-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
