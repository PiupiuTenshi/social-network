# PH06-FE-MKT-02-P2-01 — Triển khai MKT-02 P2: Chi tiết tin đăng

## Mục tiêu và phạm vi

- Phase: PH06 | Nhóm: FE | Ưu tiên: P2 | Task cha: PH06-FE-MKT-02-P2.
- Mục tiêu duy nhất: Triển khai MKT-02 P2: Chi tiết tin đăng.
- Miền: cross-cutting | Chức năng: MKT-02, MKT-07, MKT-04, CHT-01.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH06-FE-MKT-02-P2-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /cho/tin/:id. Vai trò: Người mua, Khách theo chính sách. Chỉ bật MKT-02, MKT-07, MKT-04, CHT-01 tại P2. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH06-FE-MKT-02-P2-01
...
1. Mục tiêu screen: Hiển thị ảnh, giá, tồn kho, người bán và hành động mua với dữ liệu giá chụp tại thời điểm đặt.
...
- **AC01**: Màn hình MKT-02 tại /cho/tin/:id thực hiện đúng quyền Người mua, Khách theo chính sách và capability MKT-02, MKT-07, MKT-04, CHT-01.
- **AC02**: Trạng thái riêng được kiểm chứng: - Còn hàng; - Hết hàng; - Tin đăng ẩn; - Phương tiện thiếu; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH06-FE-MKT-02-P2-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
