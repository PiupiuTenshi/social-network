...
```powershell
python -X utf8 scripts/task_gate.py check PH06-DATA-AI-P2-02
...
Ghi `TASK_ID=PH06-DATA-AI-P2-02`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
