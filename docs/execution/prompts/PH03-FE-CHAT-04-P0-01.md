# PH03-FE-CHAT-04-P0-01 — Triển khai CHAT-04 P0: Thiết lập hội thoại

## Mục tiêu và phạm vi

- Phase: PH03 | Nhóm: FE | Ưu tiên: P0 | Task cha: PH03-FE-CHAT-04-P0.
- Mục tiêu duy nhất: Triển khai CHAT-04 P0: Thiết lập hội thoại.
- Miền: cross-cutting | Chức năng: CHT-01, CHT-03.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH03-FE-CHAT-04-P0-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /tin-nhan/:id/thiet-lap. Vai trò: Thành viên, Quản trị nhóm. Chỉ bật CHT-01, CHT-03 tại P0. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH03-FE-CHAT-04-P0-01
...
1. Mục tiêu screen: Quản lý tên nhóm, thành viên, thông báo và rời hội thoại.
...
- **AC01**: Màn hình CHAT-04 tại /tin-nhan/:id/thiet-lap thực hiện đúng quyền Thành viên, Quản trị nhóm và capability CHT-01, CHT-03.
- **AC02**: Trạng thái riêng được kiểm chứng: - Mặc định; - Không có quyền quản trị; - Đang lưu; - Xung đột; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH03-FE-CHAT-04-P0-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
