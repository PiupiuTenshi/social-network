# PH06-FE-DISC-01-P2-01 — Triển khai DISC-01 P2: Tìm kiếm

## Mục tiêu và phạm vi

- Phase: PH06 | Nhóm: FE | Ưu tiên: P2 | Task cha: PH06-FE-DISC-01-P2.
- Mục tiêu duy nhất: Triển khai DISC-01 P2: Tìm kiếm.
- Miền: cross-cutting | Chức năng: AI-02, MKT-02, SOC-06.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH06-FE-DISC-01-P2-01`; chưa được tạo chỉ vì có trong prompt.
- Route: /tim-kiem. Vai trò: Người dùng. Chỉ bật AI-02, MKT-02, SOC-06 tại P2. Các chức năng ưu tiên cao hơn và gap chưa khóa phải tắt.

## Cổng bắt buộc trước khi thực hiện

```powershell
python -X utf8 scripts/task_gate.py check PH06-FE-DISC-01-P2-01
...
1. Mục tiêu screen: Tìm người dùng, bài viết, cộng đồng và tin đăng; ưu tiên FTS và nâng cấp sang tìm kiếm ngữ nghĩa khi khả dụng.
...
- **AC01**: Màn hình DISC-01 tại /tim-kiem thực hiện đúng quyền Người dùng và capability AI-02, MKT-02, SOC-06.
- **AC02**: Trạng thái riêng được kiểm chứng: - Gợi ý ban đầu; - Đang tìm; - Có kết quả; - Không có kết quả; - AI không khả dụng và dùng tìm kiếm thường; ; Ngoài các trạng thái trên, áp dụng trạng thái dùng chung trong `sources/11-state-matrix.md`.
...
Ghi `TASK_ID=PH06-FE-DISC-01-P2-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
