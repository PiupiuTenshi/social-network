# PH04-FE-AUTH-03-P1-01 — Triển khai AUTH-03 P1: Đăng ký

## Mục tiêu và phạm vi

- Phase: PH04 | Nhóm: FE | Ưu tiên: P1 | Task cha: PH04-FE-AUTH-03-P1.
- Mục tiêu duy nhất: Triển khai AUTH-03 P1: Đăng ký.
- Miền: cross-cutting | Chức năng: ACC-10.
- Chế độ: implementation. Chỉ sửa đầu ra trong phạm vi subtask; không làm task kế tiếp.
- Nhánh đề xuất: `feat/PH04-FE-AUTH-03-P1-01`; chưa được tạo chỉ vì có trong prompt.
...
```powershell
python -X utf8 scripts/task_gate.py check PH04-FE-AUTH-03-P1-01
...
- **AC01**: Màn hình AUTH-03 tại /dang-ky thực hiện đúng quyền Khách và capability ACC-10.
...
Ghi `TASK_ID=PH04-FE-AUTH-03-P1-01`, mục tiêu, file/ký hiệu đã đổi, contract/ADR, từng AC → artifact → kết quả, lệnh thật, rủi ro và blocker.
