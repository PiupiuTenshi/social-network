...
functions:
- SOC-02
desktop_svg: assets/editable/svg/desktop/set-03-tai-khoan-bi-chan.svg
mobile_svg: assets/editable/svg/mobile/set-03-tai-khoan-bi-chan.svg
review_round: 3
