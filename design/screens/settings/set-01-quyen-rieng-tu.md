...
group: Thiết lập
route: /thiet-lap/quyen-rieng-tu
priority: P0
status: approved
roles:
- Người dùng
functions:
- ACC-07
desktop_svg: assets/editable/svg/desktop/set-01-quyen-rieng-tu.svg
mobile_svg: assets/editable/svg/mobile/set-01-quyen-rieng-tu.svg
review_round: 3
